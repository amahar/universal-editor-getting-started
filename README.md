...
## Environments
- Preview: https://main--universal-editor-getting-started--amahar.aem.page/
- Live: https://main--universal-editor-getting-started--amahar.aem.live/
...
1. Open the `universal-editor-getting-started` directory in your favorite IDE and start coding :)
